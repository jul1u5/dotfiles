...
{ fetchgit, fetchurl, fetchFromGitHub, dockerTools }:
{
  ...
  "'plugin-SmoothCursor.nvim'" = {
    ...
    version = "b61173fb107455f18099715b88d86002579f2736";
    src = fetchFromGitHub {
      owner = "gen740";
      repo = "SmoothCursor.nvim";
      rev = "b61173fb107455f18099715b88d86002579f2736";
      fetchSubmodules = false;
      sha256 = "sha256-NYx/nODyVCCZ78rsmP6qKpB4F/2OuYn/pj8qw+ISCsQ=";
    };
    date = "2023-03-08";
  };
  ...
  "'plugin-carbon.nvim'" = {
    ...
    version = "779fed6aba81a7e6bc973cbbc08208db64adeccc";
    src = fetchFromGitHub {
      owner = "SidOfc";
      repo = "carbon.nvim";
      rev = "779fed6aba81a7e6bc973cbbc08208db64adeccc";
      fetchSubmodules = false;
      sha256 = "sha256-Tz7JqaK/71CwooUxSsL6cgIwvHv9lERANAggu8Vf6Ig=";
    };
    date = "2023-04-22";
  };
  "'plugin-circles.nvim'" = {
    pname = "'plugin-circles.nvim'";
    version = "01b9ac1dc6c181f6982eddd57deb1fc7f92d7a70";
    src = fetchFromGitHub {
      owner = "projekt0n";
      repo = "circles.nvim";
  ...
  "'plugin-github-nvim-theme'" = {
    ...
    version = "62b7b54a90c70c20cd1641f9facfced46bdd3561";
    src = fetchFromGitHub {
      owner = "projekt0n";
  ...
  "'plugin-neorg'" = {
    pname = "'plugin-neorg'";
    version = "474af829b0f3e25e09e68d2842ffcb6ca24d359b";
    src = fetchFromGitHub {
      owner = "nvim-neorg";
      repo = "neorg";
      rev = "474af829b0f3e25e09e68d2842ffcb6ca24d359b";
      fetchSubmodules = false;
      sha256 = "sha256-93GdT7QLKsMbmIfz7G0cAIIYmTF19caxAspw1VYAiRQ=";
    };
    date = "2023-06-06";
  };
  ...
  "'plugin-nvim-lspconfig'" = {
    ...
    version = "00d7063cdca8d39eb4e3308277cc21eae7bb44f7";
    src = fetchFromGitHub {
      owner = "neovim";
      repo = "nvim-lspconfig";
      rev = "00d7063cdca8d39eb4e3308277cc21eae7bb44f7";
      fetchSubmodules = false;
      sha256 = "sha256-h5Cl2xdfUPqFZ+8XvkLIMfypAKW3nbsmodLN6NTllGg=";
    };
    date = "2023-06-06";
  };
  "'plugin-nvim-surround'" = {
    pname = "'plugin-nvim-surround'";
    version = "10b20ca7d9da1ac8df8339e140ffef94f9ab3b18";
    src = fetchFromGitHub {
      owner = "kylechui";
      repo = "nvim-surround";
      rev = "10b20ca7d9da1ac8df8339e140ffef94f9ab3b18";
      fetchSubmodules = false;
      sha256 = "sha256-r3D5WTqEnIL1T3p7cmkRmBY8qgwFFJptM7BKNNsCT8k=";
    };
    date = "2023-05-30";
  };
  "'plugin-nvim-tetris'" = {
  ...
  "'plugin-telescope-live-grep-args.nvim'" = {
    ...
    version = "0f75ea809c46af8997c64f49c52e3c641d887885";
    src = fetchFromGitHub {
      owner = "nvim-telescope";
      repo = "telescope-live-grep-args.nvim";
      rev = "0f75ea809c46af8997c64f49c52e3c641d887885";
      fetchSubmodules = false;
      sha256 = "sha256-b9VRlw4c5fEKJs1nQTmMHDIVrj2fZ2Xe6L8nMa4q2bY=";
    };
    date = "2023-04-05";
  };
  ...
  "'plugin-undotree'" = {
    pname = "'plugin-undotree'";
    version = "485f01efde4e22cb1ce547b9e8c9238f36566f21";
    src = fetchFromGitHub {
      owner = "mbbill";
      repo = "undotree";
      rev = "485f01efde4e22cb1ce547b9e8c9238f36566f21";
      fetchSubmodules = false;
      sha256 = "sha256-VrU0usn0akKUtZarvWxL1kD7RgCVBEuZBSQHF5myd40=";
    };
    date = "2023-02-25";
  };
  "'plugin-vim-eunuch'" = {
  ...
  "'plugin-vim-sleuth'" = {
    ...
    version = "1cc4557420f215d02c4d2645a748a816c220e99b";
    src = fetchFromGitHub {
      owner = "tpope";
      repo = "vim-sleuth";
      rev = "1cc4557420f215d02c4d2645a748a816c220e99b";
      fetchSubmodules = false;
      sha256 = "sha256-ClltfSVuoNoq5EiWRVBsGz1mrr7FbafGDdgsavLgFVE=";
    };
    date = "2023-01-10";
  };
  "'plugin-vim-startuptime'" = {
    pname = "'plugin-vim-startuptime'";
    version = "454b3de856b7bd298700de33d79774ca9b9e3875";
    src = fetchFromGitHub {
      owner = "dstein64";
      repo = "vim-startuptime";
      rev = "454b3de856b7bd298700de33d79774ca9b9e3875";
      fetchSubmodules = false;
      sha256 = "sha256-8lT7EmTQqtT+hqQq406s9/iCunBOn0Znl0m4ttJdSX8=";
    };
    date = "2023-06-03";
  };
  "'plugin-vim-visual-multi'" = {
    pname = "'plugin-vim-visual-multi'";
    version = "724bd53adfbaf32e129b001658b45d4c5c29ca1a";
    src = fetchFromGitHub {
      owner = "mg979";
      repo = "vim-visual-multi";
      rev = "724bd53adfbaf32e129b001658b45d4c5c29ca1a";
      fetchSubmodules = false;
      sha256 = "sha256-Xq2guPaVNRZu8vnkEr1dYZrjou0QBbpXxgNqSBn0HTY=";
    };
    date = "2022-09-14";
  };
  "'plugin-vimtex'" = {
