...
layoutHook' =
  avoidStruts . smartBorders $ tiled ||| tabbed shrinkText def ||| Full
 where
  tiled = spacingRaw True (Border 1 1 1 1) True (Border 2 2 2 2) True
...
keys' =
  ...
  , ((0, xK_KP_Down)              , spawn "playerctl play-pause")
  , ((0, xK_KP_End)               , spawn "playerctl previous")
  , ((0, xK_KP_Next)              , spawn "playerctl next")
